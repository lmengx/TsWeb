...
public class CPlayer
{
    ...
    public int ChlorophyteArmorBaseLife = 0;
    ...
    {
        get => this.me != null && this.index >= 0 && this.index < Main.player.Length && this.me.Active && this.index == this.me.Index && this.me.TPlayer != null && this.index == this.me.TPlayer.whoAmI && this.me.TPlayer.active && this._isActive;
