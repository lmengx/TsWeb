...
public class EaterofWorldsHead : CNPC
{
    ...
    public override void OnHurtPlayers(GetDataHandlers.PlayerDamageEventArgs e)
    {
        if (global::Challenger.Challenger.config.EnableConsumptionMode)
        {
            ...
            {
                case 1:
                    global::Challenger.Challenger.SendPlayerText("毒牙咬击", new Color(177, 94, 255), this.npc.Center + new Vector2(0f, -30f));
                    break;
                case 2:
                    global::Challenger.Challenger.SendPlayerText("创死你", new Color(177, 94, 255), this.npc.Center + new Vector2(0f, -30f));
                    break;
                default:
                    global::Challenger.Challenger.SendPlayerText("呜哇哇", new Color(177, 94, 255), this.npc.Center + new Vector2(0f, -30f));
                    break;
            }
        }
    }
