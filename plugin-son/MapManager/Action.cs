...
public class Action
{
    ...
    public void Rollback()
    {
        switch (this.action)
        {
            ...
            case 20://trykilltile 
                ...
                MapManager.PaintFurniture(this.data, this.x, this.y, (byte) (this.paint & 127));
    ...
    {
        var dateTime = MapManager.Date.AddSeconds(this.time);
        ...
        {
            0 or 4 or 20 => $"{date} {this.account} 破坏方块 {this.data}. ({dhms})",
            1 => $"{date} {this.account} 放置方块 {this.data}. ({dhms})",
            2 => $"{date} {this.account} 破坏墙 {this.data}. ({dhms})",
            3 => $"{date} {this.account} 放置墙 {this.data}. ({dhms})",
            5 or 10 or 12 or 16 => $"{date} {this.account} 放置电线. ({dhms})",
            6 or 11 or 13 or 17 => $"{date} {this.account} 破坏电线. ({dhms})",
            7 or 14 => $"{date} {this.account} 改变图格形状. ({dhms})",
            8 => $"{date} {this.account} 放置致动器. ({dhms})",
            21 => $"{date} {this.account} 放置物块 ({dhms})",
            22 => $"{date} {this.account} 放置墙. ({dhms})",
            25 or 26 => $"{date} {this.account} 涂漆物块/墙. ({dhms})",
            27 => $"{date} {this.account} 修改了告示牌文字. ({dhms})",
            _ => "",
        };
    }
}