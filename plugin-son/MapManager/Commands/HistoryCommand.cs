...
public class HistoryCommand : HCommand
{
    ...
    public override void Execute()
    {
        ...
        using (var reader =
            MapManager.Database.QueryReader("SELECT Account, Action, Data, Time FROM History WHERE XY = @0 AND WorldID = @1",
        ...
        actions.AddRange(MapManager.Actions.Where(a => a.x == this.x && a.y == this.y));
    ...
    {
        return MapManager.Database.Query("DELETE FROM History") != 0;
    }
}