...
public class InfoCommand : HCommand
{
    ...
    public override void Execute()
    {
        ...
        var lookupTime = (int) (DateTime.UtcNow - MapManager.Date).TotalSeconds - this.time;
        ...
        using (var reader =
            MapManager.Database.QueryReader("SELECT Action, XY FROM History WHERE Account = @0 AND Time >= @1 AND " + XYReq + " AND WorldID = @2",
